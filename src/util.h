 ...
 */
#ifndef TENOCOIN_UTIL_H
#define TENOCOIN_UTIL_H
...
extern const char * const TENOCOIN_CONF_FILENAME;
extern const char * const TENOCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("tenocoin-%s", name);
