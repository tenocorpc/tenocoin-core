...
#ifndef TENOCOIN_QT_TENOCOINUNITS_H
#define TENOCOIN_QT_TENOCOINUNITS_H
...
/** TenoCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TenoCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TenoCoinUnits(QObject *parent);

    /** TenoCoin units.
      @note Source: https://en.tenocoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        NAV,
...
typedef TenoCoinUnits::Unit TenoCoinUnit;

#endif // TENOCOIN_QT_TENOCOINUNITS_H
