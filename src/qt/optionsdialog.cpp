    ...
    mapper(0)
{
    ...
    ui->tenocoinAtStartup->setToolTip(ui->tenocoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->tenocoinAtStartup->setText(ui->tenocoinAtStartup->text().arg(tr(PACKAGE_NAME)));
    ...
    ui->thirdPartyTxUrls->setPlaceholderText("https://chainz.cryptoid.info/teno/tx.dws?%s.htm");
#endif

    ui->unit->setModel(new TenoCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->tenocoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openTenoCoinConfButton_clicked()
{
