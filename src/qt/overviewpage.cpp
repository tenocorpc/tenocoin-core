...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(TenoCoinUnits::NAV),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = TenoCoinUnits::formatWithUnit(unit, amount, true, TenoCoinUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& stakingBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(TenoCoinUnits::formatWithUnit(unit, balance, false, TenoCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(TenoCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, TenoCoinUnits::separatorAlways));
    ui->labelStaking->setText(TenoCoinUnits::formatWithUnit(unit, stakingBalance, false, TenoCoinUnits::separatorAlways));
    ui->labelImmature->setText(TenoCoinUnits::formatWithUnit(unit, immatureBalance, false, TenoCoinUnits::separatorAlways));
    ui->labelTotal->setText(TenoCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + stakingBalance, false, TenoCoinUnits::separatorAlways));
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(TenoCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, TenoCoinUnits::separatorAlways));
    ui->label7dStakingStats->setText(TenoCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, TenoCoinUnits::separatorAlways));
    ui->label30dStakingStats->setText(TenoCoinUnits::formatWithUnit(unit, aRange[i++].Total, false, TenoCoinUnits::separatorAlways));
