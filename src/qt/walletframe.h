...
#ifndef TENOCOIN_QT_WALLETFRAME_H
#define TENOCOIN_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, TenoCoinGUI *_gui = 0);
    ~WalletFrame();
...
#endif // TENOCOIN_QT_WALLETFRAME_H
