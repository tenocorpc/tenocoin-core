...
#define BOOST_TEST_MODULE TenoCoin Test Suite

#include "test_tenocoin.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_tenocoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
