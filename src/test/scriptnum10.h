...
#ifndef TENOCOIN_TEST_SCRIPTNUM10_H
#define TENOCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from TenoCoin Core 0.10.0, for cross-comparison.
 */
public:
