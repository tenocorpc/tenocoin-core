...
unlocked to sign the TenoCoin-Qt.app bundle.
...
allowing somebody to distribute a TenoCoin-Qt.app or tenocoin-qt-setup.exe with a valid
...
that the tenocoin-qt.exe file inside the installer had not been tampered with.
