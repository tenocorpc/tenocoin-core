...
class RawTransactionsTest(TenoCoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid tenocoin address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid tenocoin address" in e.error['message'])
