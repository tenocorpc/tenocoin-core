...
This document provides guidelines for internationalization of the TenoCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tenocoin_en.ts` remains unchanged.
